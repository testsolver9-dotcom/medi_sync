...
async def run_test():
    ...
    try:
        ...
        # Click on Patient Login to proceed to login form.
        ...
        # Input OTP and click Verify OTP button.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/input').nth(0)
        ...
        # Verify the medical records data correctness and test the view and download buttons for each record.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/section/div/table/tbody/tr/td[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        assert False, 'Test plan execution failed: medical records verification could not be completed.'
